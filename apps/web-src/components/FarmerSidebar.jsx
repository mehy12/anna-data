...
export default function FarmerSidebar({ currentPage, onPageChange, onClose }) {
  ...
  const navigationItems = [
    ...
    { name: "Add Crop", icon: Package, hasSubmenu: false },
    { name: "Add Equipment", icon: Wrench, hasSubmenu: false },
    { name: "Schemes", icon: FileText, hasSubmenu: false },
    { name: "Weather", icon: Cloud, hasSubmenu: false },
  ];
